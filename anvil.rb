class Anvil < Formula
  ...
  sha256 "f1481dc96e2139bc41a22e3fcec902c9d4bcd271d2ec7aad1b7afa01fd1a89d6"
  license "MIT"
  ...
  def install
    ...
    if build.head?
      ...
      ldflags << "-X anvil/internal/usecase.revision=90229c0bda10ede8f1fc9c07207dbf52da6af653"
    end
